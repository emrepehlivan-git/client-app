...
export const getGetApiCategoryInfiniteQueryOptions = <TData = InfiniteData<Awaited<ReturnType<typeof getApiCategory>>, GetApiCategoryParams['page']>, TError = unknown>(params?: GetApiCategoryParams, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiCategory>>, TError, TData, Awaited<ReturnType<typeof getApiCategory>>, QueryKey, GetApiCategoryParams['page']>>, }
) => {
...
export function useGetApiCategoryInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiCategory>>, GetApiCategoryParams['page']>, TError = unknown>(
...
export const getGetApiCategoryQueryOptions = <TData = Awaited<ReturnType<typeof getApiCategory>>, TError = unknown>(params?: GetApiCategoryParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiCategory>>, TError, TData>>, }
) => {
...
export const getGetApiCategoryIdInfiniteQueryOptions = <TData = InfiniteData<Awaited<ReturnType<typeof getApiCategoryId>>>, TError = unknown>(id: string, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof getApiCategoryId>>, TError, TData>>, }
) => {
...
export type GetApiCategoryIdInfiniteQueryError = unknown


export function useGetApiCategoryIdInfinite<TData = InfiniteData<Awaited<ReturnType<typeof getApiCategoryId>>>, TError = unknown>(
...
const {mutation: mutationOptions} = options ?
 ...
 , queryClient?: QueryClient): UseMutationResult<
    ...
    export const deleteApiCategoryBulkDelete = (
    deleteBulkCategoriesCommand: DeleteBulkCategoriesCommand,
 ) => {
      
      
      return axiosClientMutator<void>(
      {url: `/api/Category/bulk-delete`, method: 'DELETE',
      headers: {'Content-Type': 'application/json', },
      data: deleteBulkCategoriesCommand
    },
      );
    }
...
export const getDeleteApiCategoryBulkDeleteMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiCategoryBulkDelete>>, TError,{data: DeleteBulkCategoriesCommand}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof deleteApiCategoryBulkDelete>>, TError,{data: DeleteBulkCategoriesCommand}, TContext> => {

const mutationKey = ['deleteApiCategoryBulkDelete'];
const {mutation: mutationOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteApiCategoryBulkDelete>>, {data: DeleteBulkCategoriesCommand}> = (props) => {
          const {data} = props ?? {};

          return  deleteApiCategoryBulkDelete(data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteApiCategoryBulkDeleteMutationResult = NonNullable<Awaited<ReturnType<typeof deleteApiCategoryBulkDelete>>>
    export type DeleteApiCategoryBulkDeleteMutationBody = DeleteBulkCategoriesCommand
    export type DeleteApiCategoryBulkDeleteMutationError = unknown

    export const useDeleteApiCategoryBulkDelete = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiCategoryBulkDelete>>, TError,{data: DeleteBulkCategoriesCommand}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof deleteApiCategoryBulkDelete>>,
        TError,
        {data: DeleteBulkCategoriesCommand},
        TContext
      > => {

      const mutationOptions = getDeleteApiCategoryBulkDeleteMutationOptions(options);
